...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ?? 30. ??? 18:56:30 2011
# Project:  ikey_next.pro
# Template: subdirs
# Command: c:\qtsdk\desktop\qt\4.7.4\mingw\bin\qmake.exe -spec c:\QtSDK\Desktop\Qt\4.7.4\mingw\mkspecs\win32-g++ -o Makefile ikey_next.pro
#############################################################################
...
gui\$(MAKEFILE): 
	...
	cd gui\ && $(QMAKE) d:\workspace\ikey_next\gui\gui.pro -spec c:\QtSDK\Desktop\Qt\4.7.4\mingw\mkspecs\win32-g++ -o $(MAKEFILE)
...
Makefile: ikey_next.pro  c:/QtSDK/Desktop/Qt/4.7.4/mingw/mkspecs/win32-g++/qmake.conf c:/QtSDK/Desktop/Qt/4.7.4/mingw/mkspecs/qconfig.pri \
	...
	$(QMAKE) -spec c:\QtSDK\Desktop\Qt\4.7.4\mingw\mkspecs\win32-g++ -o Makefile ikey_next.pro
